(function($) {
    ...
    $(document).ready(function() {
        ...
        var headerHeight = $mainHeader;
        var header_animation_status = 0;
        if ($("#editable-entity").length && $("#editable-entity").is(":visible")) {
            $("#main-section").css("margin-top", headerHeight + $("#editable-entity"));
        }
...
//# sourceMappingURL=/assets/js/app-16d3992810a6860e4187a5917d4b61a3.js.map